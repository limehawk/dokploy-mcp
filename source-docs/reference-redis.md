...
1 <= length
```
databasePassword*stringdockerImage?stringDefault
```
"redis:8"
```
...
## Request Body
application/json
redisId*string[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
## Request Body
application/json
redisId*stringappName*stringLength
```
1 <= length
```
[key: string]?never
...
## Request Body
application/json
redisId*stringexternalPort*number|null[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
## Request Body
application/json
redisId*stringapplicationStatus*stringValue in
```
...
## Request Body
application/json
redisId*stringenv?string|null[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
1 <= length
```
description?string|nulldatabasePassword?stringdockerImage?stringDefault
```
"redis:8"
```
command?string|nullargs?array|nullenv?string|nullmemoryReservation?string|nullmemoryLimit?string|nullcpuReservation?string|nullcpuLimit?string|nullexternalPort?number|nullcreatedAt?stringapplicationStatus?stringValue in
```
"idle" | "running" | "done" | "error"
```
healthCheckSwarm?object|nullrestartPolicySwarm?object|nullplacementSwarm?object|nullupdateConfigSwarm?object|nullrollbackConfigSwarm?object|nullmodeSwarm?object|nulllabelsSwarm?object|nullnetworkSwarm?array|nullstopGracePeriodSwarm?integer|nullendpointSpecSwarm?object|nullreplicas?numberenvironmentId?string[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
## Request Body
application/json
redisId*stringtargetEnvironmentId*string[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
```
[RedirectsPrevious Page](/docs/api/reference-redirects)[RegistryNext Page](/docs/api/reference-registry)