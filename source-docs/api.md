...
[Dokploy](https://dokploy.com)Dokploy APIFor Administrators
# Dokploy API
How to interact with the dokploy API for administrators and users
...
```
[AdminNext Page](/docs/api/admin)
### On this page
[For Administrators](#for-administrators)[For Users](#for-users)[Usage](#usage)[Authentication](#authentication)