...
1 <= length
```
description?string|nullipAddress*stringport*numberusername*stringsshKeyId*string|nullserverType*stringValue in
```
"deploy" | "build"
```
[key: string]?never
...
1 <= length
```
description?string|nullserverId*stringLength
```
1 <= length
```
ipAddress*stringport*numberusername*stringsshKeyId*string|nullserverType*stringValue in
```
"deploy" | "build"
```
command?string[key: string]?never
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
In: header
## Query Parameters
url*stringtoken*stringdataPoints*string
## Response Body
### 200application/json
### defaultapplication/json
cURLJavaScriptGoPythonJavaC#
...
```
[SecurityPrevious Page](/docs/api/reference-security)[SettingsNext Page](/docs/api/reference-settings)